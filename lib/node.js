...
Node.prototype.getInfo = function(callback)
{
	...
	return {
		...
		stats: {
            ...
            ticketNumber : this.stats.ticketNumber,
            myTicketNumber:(this.stats.myTicketNumber == null) ? 'No tickets' : this.stats.myTicketNumber,
...
Node.prototype.setBasicStats = function(stats, callback)
{
    ...
    if( !_.isUndefined(stats) )
	{
		if( !_.isEqual(stats, {
			...
			gasPrice: this.stats.gasPrice,
            ticketNumber:this.stats.ticketNumber,
            myTicketNumber:this.stats.myTicketNumber,
			uptime: this.stats.uptime
		}) )
		{
            ...
            this.stats.ticketNumber = stats.ticketNumber;
            this.stats.myTicketNumber = stats.myTicketNumber==null ? 'No tickets' : stats.myTicketNumber;
			this.stats.uptime = stats.uptime;

			callback(null, this.getBasicStats());
            console.log(`${this.info.name} owns ${this.stats.myTicketNumber} tickets.`);
