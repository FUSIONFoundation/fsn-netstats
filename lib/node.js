...
Node.prototype.getInfo = function(callback)
{
	...
	return {
		...
		stats: {
            ...
            myTicketNumber:(this.stats.myTicketNumber == null) ? 'N/A' : this.stats.myTicketNumber,
...
Node.prototype.setBasicStats = function(stats, callback)
{
    ...
    if( !_.isUndefined(stats) )
	{
		...
		}) )
		{
            ...
            this.stats.myTicketNumber = stats.myTicketNumber==null ? 'N/A' : stats.myTicketNumber;
